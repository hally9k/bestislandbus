...
<section css={quartinarySectionStyles}>
  <div css={guestBookEntryStyle}>
    <p>
      <span className="quotes">&#x201C;</span><p> <br />Absolutely amazing place... the bus is so nice and the couple have done a fantastic job working on it... the place is very peaceful and have a very nice view... the garden is beautiful... there is everything you need. It's a 10 out 10.</p>
      <br />
  ...
  <div css={guestBookEntryStyle}>
    <p>
      <span className="quotes">&#x201C;</span><p> <br />Words can't describe how truly amazing this place is! My sister and I were absolutely blown away with our night here. As we've travelled around New Zealand, this is our favorite stay so far. I always search for a unique or quirky accommodation, something a little different and out of the ordinary. Clare and Simon certainly went above and beyond to make this feel like a magical night away, a strong 10/10!</p>
      <br />
