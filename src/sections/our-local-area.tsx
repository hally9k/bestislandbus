...
export const OurLocalArea = () => <React.Fragment>
  ...
  <section css={sectionContainerStyles}>
    <section css={quartinarySectionStyles}>
      ...
      <p css={ideasItemStyles}><a css={ideasLinkStyles} href="https://www.theprow.org.nz/places/miyazu-garden/" target="_blank" rel="noopener noreferrer">Miyazu Japanese Gardens</a> and <a css={ideasLinkStyles} href="https://www.nelson360.co.nz/things-to-do-and-see/attractions/queens-gardens/" target="_blank" rel="noopener noreferrer">Queens Gardens</a> in Nelson</p>
